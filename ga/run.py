...
def run_ga():
    ...
    print_and_save(f'Initialized {Config.population_size} inidividuals.', log_file_path)
    ...
    while True:
        ...
        for id, individual in enumerate(population.individuals):
            ...
            if id in id_elite:
                ...
                parent = population.individuals[parent_id]
                population.configure_from_mutation(id, parent)
